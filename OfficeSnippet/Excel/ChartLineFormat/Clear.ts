module CodeSnippets {
    export function snippet_ChartLineFormat_Clear(): IInternalSnippet {
        return {
            name: "",
            category: "",
            ...
            code: {
                jsOrTs: function () {
                    return Excel.run(function (ctx) {
						var gridlines = ctx.workbook.worksheets.getItem("Sheet1")
							.charts.getItem("Chart1").axes.valueAxis.majorGridlines;
